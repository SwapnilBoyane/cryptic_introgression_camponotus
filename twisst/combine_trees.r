...
# write tree info
write.table(cbind(x_chrom, x_start, x_end), file="camphybrid_twisst_50kbp_tree_info.txt", sep="\t", quote=F, row.names=F, col.names=F)
...
write(tree_list, file="camphybrid_twisst.trees", ncolumns=1)
